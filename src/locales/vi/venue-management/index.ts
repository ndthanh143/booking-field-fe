export const vi_venue_management = {
  'app.dashboard': 'Trang chủ',
  'app.your-venue': 'Sân của bạn',
  'app.booking': 'Đặt sân của bạn',
  ...
  'app.dashboard.booking.title': 'Thống kê số lượng sân được sử dụng',
  'app.dashboard.booking.chart.title': 'Số lần đặt sân',

  'app.your-venue.tabs.info': 'Thông tin',
  'app.your-venue.tabs.button.edit': 'Chỉnh sửa',
  'app.your-venue.tabs.button.save': 'Lưu thay đổi',
  ...
  'app.your-venue.tabs.pitch.update-box.title': 'Cập nhật sân bóng',
  'app.your-venue.tabs.pitch.add-box.name': 'Tên sân',
  'app.your-venue.tabs.pitch.add-box.price-per-hour': 'Giá sân theo giờ',
  'app.your-venue.tabs.pitch.add-box.category': 'Loại sân',
};
